# =====================================================================
# Project:     Bare-Metal ESP32-C3 Assembly SSD1306 Vertical Scroller & LED
# Author:      agguro
# Date:        August 11, 2026
# Description: Pure assembly bare-metal driver to initialize SSD1306 OLED,
#              render a vertical scrolling text engine, flush via 
#              I2C (SDA=GPIO5, SCL=GPIO6), and keep the LED on GPIO 8 ON
# =====================================================================
...
# =========================================================
# BLOCK: VERTICAL SCROLLER MAIN APPLICATION
# Initialize scroll tracking and execute vertical shift loop
# =========================================================
.L_start_vscroller:
    jal  fb_clear
...
# =========================================================
# ROUTINE: V_SCROLL_STEP
# Shifts framebuffer up by 1 pixel and injects bottom row via zero-copy index
# =========================================================
v_scroll_step:
    addi sp, sp, -16
    sw   ra, 12(sp)
...
# Clear framebuffer and flush RAM buffer via I2C to display RAM
# =========================================================
...
# Safely enable GPIO 8 output, turn active-low LED ON permanently, and halt
# =========================================================
main_loop:
...
# Constants, vertical text source table, variables, and framebuffer
# =========================================================
    .align 4
ssd1306_init_cmds:
...
# ---------------------------------------------------------
    .align 4
v_text_source:
    .byte 0x80, 0x00, 0x00, 0x80, 0x80, 0x80, 0x00, 0x00, 0x00
...
# Variables and Framebuffer in RAM
    .align 4
v_scroll_pos:
    .word 0
